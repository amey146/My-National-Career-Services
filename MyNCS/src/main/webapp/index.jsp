...
<script type="text/javascript">
	document.getElementById('frmSearch').onsubmit = function() {
		window.location = 'http://127.0.0.1:5500/index.jsp '
...
<body>
	<div class="container-xxl bg-white p-0">
		...
		<div class="container-fluid bg-primary mb-5 wow fadeIn"
			...
			<div class="container">
				<div class="row g-2">
					...
					<div class="col-md-2">
						<a href="login.jsp" class="btn btn-dark border-0 w-100"
							role="button">Login</a>
					</div>
					<div class="col-md-2">
						<a href="register.jsp" class="btn btn-dark border-0 w-100"
					...
					%>
					<div class="col-md-2">
						<a href="profile.jsp" class="btn btn-dark border-0 w-100"
							role="button">Profile</a>
					</div>
					<div class="col-md-2">
						<a href="Logout" class="btn btn-dark border-0 w-100"
		...
		<div class="container-xxl py-5">
			<div class="container">
				<h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">What
					do you want to do</h1>
				<div class="row g-4">
					...
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
						<a class="cat-item rounded p-4" href=""> <i
							...
							<p class="mb-0">Post a Job/ Talent Hunt</p>
						</a>
					</div>
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
						<a class="cat-item rounded p-4" href=""> <i
							class="fa fa-3x fa-user-tie text-primary mb-4"></i>
							<h6 class="mb-3">Government Employer</h6>
							<p class="mb-0">Post a Job/ Find Candidates</p>
						</a>
					</div>
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
						<a class="cat-item rounded p-4" href=""> <i
							class="fa fa-3x fa-tasks text-primary mb-4"></i>
							<h6 class="mb-3">Placement Organization</h6>
							<p class="mb-0">Post a Job/ Find Candidates</p>
						</a>
					</div>
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
						<a class="cat-item rounded p-4" href=""> <i
							class="fa fa-3x fa-chart-line text-primary mb-4"></i>
							<h6 class="mb-3">Resources</h6>
							<p class="mb-0">GR/ Letters/ Circulars</p>
						</a>
					</div>
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
						<a class="cat-item rounded p-4" href=""> <i
							class="fa fa-3x fa-hands-helping text-primary mb-4"></i>
							<h6 class="mb-3">Career Center</h6>
							<p class="mb-0">123 Vacancy</p>
						</a>
					</div>
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
						<a class="cat-item rounded p-4" href=""> <i
							class="fa fa-3x fa-book-reader text-primary mb-4"></i>
							<h6 class="mb-3">Counsellors</h6>
							<p class="mb-0">123 Vacancy</p>
						</a>
					</div>
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
						<a class="cat-item rounded p-4" href=""> <i
							class="fa fa-3x fa-drafting-compass text-primary mb-4"></i>
							<h6 class="mb-3">International Jobs</h6>
							<p class="mb-0">123 Vacancy</p>
						</a>
					</div>
				</div>
			...
			<div class="container">
				<div class="row g-5 align-items-center">
					...
					<div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
						<h1 class="mb-4">We Help To Get The Best Job And Find A
							Talent</h1>
